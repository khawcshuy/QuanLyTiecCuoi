...
WHERE 
    TABLE_NAME = 'HOADON' AND 
    CONSTRAINT_TYPE = 'FOREIGN KEY';

ALTER TABLE HOADON
DROP CONSTRAINT FK__HOADON__IDNHANVI__6E01572D

EXEC sp_rename 'HOADON.IDNHANVIEN', 'TENNHANVIEN', 'COLUMN';

ALTER TABLE HOADON
ALTER COLUMN TENNHANVIEN VARCHAR(100);
