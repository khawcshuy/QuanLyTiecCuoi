...
INSERT INTO SANHINFOR VALUES(N'Sảnh Violet',N'A',100,1000000,100000000,0,DEFAULT)
INSERT INTO SANHINFOR VALUES(N'Sảnh Lavender',N'B',200,1100000,200000000,1,DEFAULT)
INSERT INTO SANHINFOR VALUES(N'Sảnh Ruby',N'C',300,1200000,300000000,0,DEFAULT)
INSERT INTO SANHINFOR VALUES(N'Sảnh Pearl',N'D',400,1400000,4000000,1,DEFAULT)
INSERT INTO SANHINFOR VALUES(N'Sảnh Rose',N'E',500,1600000,50000000,1,DEFAULT)

SELECT * FROM SANHINFOR

UPDATE SANHINFOR
SET PICTURE = (SELECT BulkColumn FROM OPENROWSET(BULK 'C:\TuyetMinh\QuanLyTiecCuoi\QuanLyTiecCuoi\Resources\sanh1.JPG', SINGLE_BLOB) AS x);
